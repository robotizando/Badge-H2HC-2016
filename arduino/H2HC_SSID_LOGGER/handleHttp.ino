...
void handleRoot() {
  ...
  vin = analogRead( A0 );
  server.sendContent(String("<p>Valor da Bateria: ") + String(vin) + "</p>");


  server.sendContent(String("Latitude: ") + gps.location.lat() ) ;
  server.sendContent(String("Longitude: ") + gps.location.lng() ) ;  
  ...
  server.sendContent(
    "<p>You may want to change all of your passwords</p>"
    "</body></html>"
  );
